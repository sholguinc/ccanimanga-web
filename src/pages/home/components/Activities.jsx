    ...
    return (
        ...
        <section className="workshops ">
            ...
            <div className="grid lg:grid-cols-5">
                ...
                {
                    // MODIFIED: Changed the "homeGrid" variable to "homeGrid.slice(0, 4)" to only show the first 4 elements of the array.
                    homeGrid.map((workshop, index) => (
                        <Link href={workshop.path} key={index}>
                            <a className={
                                ...
                                ${ workshop.name === "" ? "xsm:max-md:aspect-h-1 xsm:max-sm:col-span-2 sm:max-lg:row-start-1 sm:max-lg:row-end-3 sm:max-lg:col-end-4" : "" }`
                            }>
